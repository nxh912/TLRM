...
def train_input_fn(train_input, train_out, train_target_dec, train_target_queue, batch_size):
    ...
    dataset = tf.data.Dataset.from_tensor_slices((train_input_enc, train_input_dist, train_input_time, train_input_queue, train_input_users, train_output_dec, train_output_dist, train_output_time, train_output_queue, train_output_users, train_target_dec, train_target_queue))
    # Decay entire data
...
def eval_input_fn(eval_input, eval_out, eval_target_dec, eval_target_queue, batch_size):
    (eval_input_enc, eval_input_dist, eval_input_time, eval_input_users, eval_input_queue) = eval_input
    ...
    # Divide the three into one sentence each.
    dataset = tf.data.Dataset.from_tensor_slices((eval_input_enc, eval_input_dist, eval_input_time, eval_input_queue, eval_input_users,  eval_output_dec, eval_output_dist, eval_output_time, eval_output_queue, eval_out_users, eval_target_dec, eval_target_queue))
    # Shuffle entire data
...
if __name__ == '__main__':
    ...
    # print("eval target queue = ", eval_target_queue)
